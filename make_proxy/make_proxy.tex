...
With \textit{make\_proxy}, SBO (small buffer optimization) may implicitly apply to void the potential overhead that may come from unnecessary heap allocations.
